...
[![My Skills](https://skillicons.dev/icons?i=java,spring,postgres,python,mysql,git,mongo,redis,kafka,docker,githubactions,maven,postman,idea)](https://skillicons.dev)
